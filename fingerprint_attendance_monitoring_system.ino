...
#include <Wire.h>
#include "RTClib.h" //library file for DS1307 RTC Module
RTC_DS1307 rtc;
...
void printDateTime(const DateTime &ts)
{
...
// found a match!
DateTime ts = rtc.now();          // grab current RTC time

Serial.print("Found ID #");
Serial.print(finger.fingerID);
Serial.print(" at ");
printDateTime(ts);                // <‑‑ new helper
